...
public enum OutputModes : uint
{
	...
	/// </summary>
	ProcessedOutput = ENABLE.ENABLE_PROCESSED_OUTPUT,
	/// <summary>
	...
	/// </summary>
	ScrollAtBufferEnd = ENABLE.ENABLE_WRAP_AT_EOL_OUTPUT,
	/// <summary>
	...
	/// </summary>
	VirtualTerminalProcessing = ENABLE.ENABLE_VIRTUAL_TERMINAL_PROCESSING,
	/// <summary>DISABLE_NEWLINE_AUTO_RETURN</summary>
	NoImplicitCROnLF = Windows.DISABLE_NEWLINE_AUTO_RETURN, //TODO verify all the yapping from the docs
	/// <summary>
	...
	/// </summary>
	LvbGridWorldwide = ENABLE.ENABLE_LVB_GRID_WORLDWIDE //TODO can you really use the line thing and color reversing?
}
